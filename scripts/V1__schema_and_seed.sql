-- SIGEA-GTT: Flyway Migration V1
-- PostgreSQL 16 LTS Compatible
...
CREATE TABLE users (
    ...
    registration_number VARCHAR(30) NULL, -- Obrigatório apenas para STUDENT
...
CREATE TABLE harm_severities (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    category_letter CHAR(1) NOT NULL UNIQUE,
    name VARCHAR(100) NOT NULL,
    description TEXT NOT NULL,
...
CREATE TABLE academic_classes (
    ...
    academic_period VARCHAR(10) NOT NULL, -- Ex: 2026.2
...
CREATE TABLE activity_submissions (
    ...
    student_id UUID NOT NULL REFERENCES users(id) ON DELETE RESTRICT,
    identified_triggers JSONB NOT NULL, -- Lista de gatilhos e eventos adversos com gravidade E-I
    quality_tools_data JSONB NOT NULL, -- Ishikawa, PDCA, GUT, SWOT, 5W2H, Brainstorming
...
-- ====================================================================
-- CARGA DE DADOS (SEEDS OBRIGATÓRIOS)
-- ====================================================================

-- 1. Usuário Administrador Inicial (Senha inicial: SigeaUFS@2026 - hash BCrypt)
INSERT INTO users (id, full_name, email, password_hash, role, registration_number, must_change_password)
VALUES (
    uuid_generate_v4(),
...
-- 2. Classificações de Gravidade (A a I)
...
-- 4. Gatilhos Oficiais do IHI-GTT (53 Gatilhos)
