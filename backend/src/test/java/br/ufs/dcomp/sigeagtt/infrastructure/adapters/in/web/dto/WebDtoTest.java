...
class WebDtoTest {
    ...
    @Test
    @DisplayName(
            "Deve cobrir AlterarSenhaDTO, PrimeiroAcessoRequisicaoDTO, LoginRequisicaoDTO e LoginRespostaDTO")
    void deveCobrirDtosAutenticacao() {
        ...
        PrimeiroAcessoRequisicaoDTO prim =
                new PrimeiroAcessoRequisicaoDTO(1L, "atual", "nova", "nova");
    ...
    void deveCobrirDtosUnidadeHospitalar() {
        ...
        UnidadeHospitalarRequisicaoDTO req =
                new UnidadeHospitalarRequisicaoDTO("UTI-A", "UTI Adulto");
    ...
    void deveCobrirDtosModuloGtt() {
        ModuloGtt m =
                new ModuloGtt(1L, "CUIDADOS", "Cuidados Gerais", "Desc", true, LocalDateTime.now());
    ...
    void deveCobrirDtosGatilhoGtt() {
        ...
        GatilhoGttRequisicaoDTO req =
                new GatilhoGttRequisicaoDTO(5L, "M1", "Vitamina K", "INR > 5");
    ...
    void deveCobrirDtosCasoClinico() {
        ...
        SalvarCasoClinicoDTO salvarDto =
                new SalvarCasoClinicoDTO(
                        2L,
                        "Caso Sepse",
                        "Desc",
                        "Obj",
    ...
    void deveCobrirDtosAtividadeEducacional() {
        ...
        // Testar turma com professorResponsavel nulo e casoClinico com unidadeHospitalar nulo
        ...
        SalvarAtividadeDTO salvarDto =
                new SalvarAtividadeDTO(
                        10L,
                        100L,
                        "Auditoria 1",
                        "Ori",
    ...
    void deveCobrirPainelEProgressoDtos() {
        ...
        DadosPainelAtividade dadosSemAlunos =
                new DadosPainelAtividade(
    ...
    void deveCobrirDtosSubmissaoEComponentes() {
        ...
        SubmissaoIshikawa ish =
                new SubmissaoIshikawa(1L, sub, "Efeito", "Met", "Mao", "Mat", "Med", "Amb", "Maq");
        sub.setIshikawa(ish);

        SubmissaoPlano5w3h p =
        ...
        // SubmissaoDTO com campos intermediários nulos (atividade com turma sem professor e sem
        // caso clínico)
        ...
        SalvarSubmissaoDTO salvSubFalso =
                new SalvarSubmissaoDTO(600, false, null, null, null, null);
