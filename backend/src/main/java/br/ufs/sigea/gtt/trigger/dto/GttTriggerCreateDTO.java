...
@AllArgsConstructor
@Builder
@Schema(description = "Requisição de criação de Gatilho IHI-GTT")
public class GttTriggerCreateDTO {
    ...
    @Schema(description = "Código do gatilho clínico (ex: C1, M4, S10, I2, P4, E1)", example = "C1")
    private String code;
