...
/**
 * DTO para atualização cadastral de uma Categoria de Gravidade NCC MERP existente.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(description = "Requisição de atualização de Categoria de Gravidade de Dano")
public class HarmSeverityUpdateDTO {
