...
/**
 * DTO para atualização cadastral de um Módulo GTT existente.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(description = "Requisição de atualização de Módulo GTT")
public class GttModuleUpdateDTO {
    ...
    @Schema(description = "Nome descritivo do módulo", example = "Cuidados Gerais")
    private String name;
