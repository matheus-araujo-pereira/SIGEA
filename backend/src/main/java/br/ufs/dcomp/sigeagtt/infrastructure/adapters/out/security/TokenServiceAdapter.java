...
/**
 * Adaptador de infraestrutura para geração e validação de tokens JWT (HS256). Implementa a porta de
 * saída de domínio {@link TokenServicePort}.
 */
@Component
public class TokenServiceAdapter implements TokenServicePort {
    ...
    public String gerarToken(Usuario usuario) {
        try {
            ...
            payload.put("perfil", usuario.getPerfil() != null ? usuario.getPerfil().name() : "");
