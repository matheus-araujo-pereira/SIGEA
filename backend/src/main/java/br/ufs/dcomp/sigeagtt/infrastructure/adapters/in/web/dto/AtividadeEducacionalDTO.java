...
/**
 * Payload de resposta com dados resumidos de atividade educacional e contagens
 * de participação.
 *
 ...
 * @param casoClinicoUnidadeSigla  Sigla da unidade hospitalar de internação do
 *                                 caso.
...
public record AtividadeEducacionalDTO(
                ...
                @Schema(description = "Código da disciplina", example = "MED001") String turmaCodigoDisciplina,
                @Schema(description = "Código da disciplina / turma", example = "MED001") String turmaCodigo,
                @Schema(description = "Nome da disciplina da turma", example = "Segurança do Paciente e Auditoria Clínica") String turmaDisciplina,
                ...
                @Schema(description = "Nome do professor responsável", example = "Prof. Dr. Marcos") String professorResponsavelNome,
                @Schema(description = "ID do caso clínico", example = "200") Long casoClinicoId,
                @Schema(description = "Título do caso clínico", example = "Sepse Grave com Choque Séptico") String casoClinicoTitulo,
                @Schema(description = "Sigla da unidade hospitalar", example = "UTI-A") String casoClinicoUnidadeSigla,
                @Schema(description = "Título da atividade", example = "Auditoria Retrospectiva GTT - Módulo UTI") String titulo,
                @Schema(description = "Orientações pedagógicas", example = "Realizar auditoria em até 20 minutos...") String orientacoesPedagogicas,
                @Schema(description = "Data de início", example = "2026-09-12T08:00:00") LocalDateTime dataInicio,
                @Schema(description = "Data de término", example = "2026-09-20T23:59:59") LocalDateTime dataFim,
                ...
                @Schema(description = "Data de cadastro", example = "2026-09-12T08:00:00") LocalDateTime criadaEm,
                @Schema(description = "Total de alunos matriculados na turma", example = "30") int totalAlunos,
                @Schema(description = "Total de alunos matriculados na turma (alias)", example = "30") int totalAlunosTurma,
                @Schema(description = "Total de submissões entregues", example = "25") int totalSubmissoes,
                @Schema(description = "Total de submissões avaliadas pelo docente", example = "20") int totalAvaliadas) {
